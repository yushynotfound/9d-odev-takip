...
const dersVerileri = [
    // Pazartesi
    { gun: 'pazartesi', saat: 1, dersAdi: 'Türk Dili ve Edebiyatı', odev: 'Evet', not: 'Edebiyatın diğer sanatlar ile ilişkisi' },
    ...
    { gun: 'pazartesi', saat: 7, dersAdi: 'Tarih', odev: 'Hayır', not: '' },
    { gun: 'pazartesi', saat: 8, dersAdi: 'Adabımuaşeret', odev: 'Hayır', not: '' },
    
    // Salı
    { gun: 'salı', saat: 1, dersAdi: 'Matematik', odev: 'Evet', not: 'Hocanın attığı test + 2 test' },
    { gun: 'salı', saat: 2, dersAdi: 'Matematik', odev: 'Evet', not: 'Hocanın attığı test + 2 test' },
    { gun: 'salı', saat: 3, dersAdi: 'Rehberlik', odev: 'Hayır', not: '' },
    { gun: 'salı', saat: 4, dersAdi: 'Sağlık', odev: 'Hayır', not: '' },
    { gun: 'salı', saat: 5, dersAdi: 'Müzik', odev: 'Hayır', not: '' },
    { gun: 'salı', saat: 6, dersAdi: 'Coğrafya', odev: 'Evet', not: 'Coğrafyanın önemiyle ilgili gazete haberi' },
    { gun: 'salı', saat: 7, dersAdi: 'Temel Dini Bilgiler', odev: 'Hayır', not: '' },
    { gun: 'salı', saat: 8, dersAdi: 'Türk Dili ve Edebiyatı', odev: 'Hayır', not: '' },
    
    // Çarşamba
    { gun: 'çarşamba', saat: 1, dersAdi: 'Din Kültürü ve Ahlak Bilgisi', odev: 'Hayır', not: '' },
    { gun: 'çarşamba', saat: 2, dersAdi: 'Almanca', odev: 'Hayır', not: '' },
    { gun: 'çarşamba', saat: 3, dersAdi: 'İngilizce', odev: 'Evet', not: 'Gateaway Workbook Starter Unit' },
    ...
    { gun: 'çarşamba', saat: 7, dersAdi: 'İngilizce', odev: 'Evet', not: 'Gateaway Workbook Starter Unit' },
    { gun: 'çarşamba', saat: 8, dersAdi: 'İngilizce', odev: 'Evet', not: 'Gateaway Workbook Starter Unit' },
    
    // Perşembe
    { gun: 'perşembe', saat: 1, dersAdi: 'İngilizce', odev: 'Evet', not: 'Workbook Unit 1' },
    ...
    { gun: 'perşembe', saat: 5, dersAdi: 'Matematik', odev: 'Evet', not: '1 Test' },
    { gun: 'perşembe', saat: 6, dersAdi: 'Matematik', odev: 'Evet', not: '1 Test' },
    { gun: 'perşembe', saat: 7, dersAdi: 'Biyoloji', odev: 'Evet', not: 'Ders kitabı okuma ve etkinlikler' },
    { gun: 'perşembe', saat: 8, dersAdi: 'Biyoloji', odev: 'Evet', not: 'Ders kitabı okuma ve etkinlikler' },
    
    // Cuma
    { gun: 'cuma', saat: 1, dersAdi: 'Tarih', odev: 'Evet', not: 'Ders kitabı etkinlikleri ve özet çıkarma' },
    { gun: 'cuma', saat: 2, dersAdi: 'Din Kültürü ve Ahlak Bilgisi', odev: 'Hayır', not: '' },
    { gun: 'cuma', saat: 3, dersAdi: 'Müzik', odev: 'Evet', not: 'İstiklal marşı okuma' },
    { gun: 'cuma', saat: 4, dersAdi: 'Türk Dili ve Edebiyatı', odev: 'Hayır', not: '' },
    { gun: 'cuma', saat: 5, dersAdi: 'Kimya', odev: 'Evet', not: 'Yaptığımız deneylerin analizi' },
    { gun: 'cuma', saat: 6, dersAdi: 'Kimya', odev: 'Evet', not: 'Yaptığımız deneylerin analizi' },
