...
const dersVerileri = [
    ...
    // Salı
    { gun: 'salı', saat: 1, dersAdi: 'Matematik', odev: 'Hayır', not: ''  },
    { gun: 'salı', saat: 2, dersAdi: 'Matematik', odev: 'Hayır', not: ''  },
    ...
    { gun: 'cuma', saat: 5, dersAdi: 'Kimya', odev: 'Hayır', not: '' },
    { gun: 'cuma', saat: 6, dersAdi: 'Kimya', odev: 'Hayır', not: '' },
...
const dersVerileri = [
    ...
    { gun: 'salı', saat: 3, dersAdi: 'Rehberlik', odev: 'Hayır', not: '' },
    { gun: 'salı', saat: 4, dersAdi: 'Almanca', odev: 'Evet', not: 'Kitap ödevi' },
    { gun: 'salı', saat: 5, dersAdi: 'İngilizce', odev: 'Evet', not: 'Workbook' },
    { gun: 'salı', saat: 6, dersAdi: 'Sağlık', odev: 'Hayır', not: ''  },
    { gun: 'salı', saat: 7, dersAdi: 'Türk Dili ve Edebiyatı', odev: 'Evet', not: "San'at şiiri" },
    { gun: 'salı', saat: 8, dersAdi: 'Türk Dili ve Edebiyatı', odev: 'Evet', not: "San'at şiiri" },
    ...
    { gun: 'cuma', saat: 3, dersAdi: 'Din Kültürü ve Ahlak Bilgisi', odev: 'Hayır', not: '' },
    { gun: 'cuma', saat: 4, dersAdi: 'Tarih', odev: 'Hayır', not: '' },
    { gun: 'cuma', saat: 5, dersAdi: 'Kimya', odev: '', not: '' },
    { gun: 'cuma', saat: 6, dersAdi: 'Kimya', odev: '', not: '' },
    { gun: 'cuma', saat: 7, dersAdi: 'Beden Eğitimi', odev: 'Hayır', not: 'Top getirin' },
    { gun: 'cuma', saat: 8, dersAdi: 'Beden Eğitimi', odev: 'Hayır', not: 'Top getirin' },
];
